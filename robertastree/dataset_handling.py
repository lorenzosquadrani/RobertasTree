...
class RobertasTreeDatasetForClassification(Dataset):
    ...
    ----------
        data : pandas.Dataframe
            Must have a columns named 'excerpt', containing texts to be classified, and a column named
            'label', containing corresponding labels.

        tokenizer : Huggingface Tokenizer 

        max_len : int
            Maximum number of tokens for a text sample. All samples will be padded/truncated to it.    
    '''
